...
export const findUpscalerUltimateSDUpscaler = (
  ...upscaleName: string[]
): IUpscaler | undefined => {
...
export const findADetailersModel = (
  ...adetaileName: string[]
): string | undefined => {
...
export const findControlnetModel = (
  ...modelsName: string[]
): IModel | undefined => {
...
export const findControlnetModule = (
  ...modelsName: string[]
): string | undefined => {
